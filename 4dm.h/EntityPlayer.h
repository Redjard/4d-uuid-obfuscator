...
namespace fdm 
{
	...
	public:
		...
		{
			msvc_string result;
			return reinterpret_cast<msvc_string& (__thiscall*)(EntityPlayer* self, msvc_string* result)>(getFuncAddr((int)Func::EntityPlayer::getName))(this, &result);
			return result;
		}
