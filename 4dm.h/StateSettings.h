...
namespace fdm 
{
	...
	public:
		...
		nlohmann::json getSetting(msvc_string& settingName, nlohmann::json& settings, const nlohmann::json& defaultSettings) 
		{
			return reinterpret_cast<nlohmann::json (__thiscall*)(StateSettings* self, msvc_string& settingName, nlohmann::json& settings, const nlohmann::json& defaultSettings)>(getFuncAddr((int)Func::StateSettings::getSetting))(this, settingName, settings, defaultSettings);
		}
