...
namespace fdm 
{
	...
	public:
		...
		std::vector<msvc_string> worldPaths; // 0x340
		...
		void queueWorldLoad(msvc_string& path) 
		{
			return reinterpret_cast<void (__thiscall*)(StateSingleplayer* self, msvc_string& path)>(getFuncAddr((int)Func::StateSingleplayer::queueWorldLoad))(this, path);
		}
	};
}
