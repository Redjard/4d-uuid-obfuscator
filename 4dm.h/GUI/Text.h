...
namespace fdm::gui
{
	...
	public:
		...
		void setText(const msvc_string& text) 
		{
			return reinterpret_cast<void (__thiscall*)(gui::Text* self, const msvc_string& text)>(getFuncAddr((int)Func::gui_Nested::Text::setText))(this, text);
		}
		void renderText(gui::Window* w, const msvc_string& text, int x, int y, bool align) 
		{
			return reinterpret_cast<void (__thiscall*)(gui::Text* self, gui::Window* w, const msvc_string & text, int x, int y, bool align)>(getFuncAddr((int)Func::gui_Nested::Text::renderText))(this, w, text, x, y, align);
		}
	};
}
