...
namespace fdm 
{
	...
	public:
		...
		msvc_string getFilenamePrefix() 
		{
			msvc_string result;
			return reinterpret_cast<msvc_string& (__thiscall*)(Chunk* self, msvc_string* result)>(getFuncAddr((int)Func::Chunk::getFilenamePrefix))(this, &result);
			return result;
		}
	};
}
