...
namespace fdm::Connection
{
	...
	public:
		...
		{
			reinterpret_cast<void(__thiscall*)(Connection::OutMessage*, unsigned short type, const msvc_string& content)>(getFuncAddr((int)Func::Connection_Nested::OutMessage::OutMessage))(this, type, content);
		}
