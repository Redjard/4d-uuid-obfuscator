...
namespace fdm 
{
	...
	public:
		...
		Inventory* findInventory(World* world, Player* player, const msvc_string& inventoryName) 
		{
			return reinterpret_cast<Inventory* (__thiscall*)(InventoryManager* self, World* world, Player* player, const msvc_string& inventoryName)>(getFuncAddr((int)Func::InventoryManager::findInventory))(this, world, player, inventoryName);
		}
