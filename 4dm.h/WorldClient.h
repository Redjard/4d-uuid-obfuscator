...
namespace fdm 
{
	...
	public:
		...
		void sendChatMessage(Player* player, const msvc_string& message) override
		{
			return reinterpret_cast<void (__thiscall*)(WorldClient* self, Player* player, const msvc_string& message)>(getFuncAddr((int)Func::WorldClient::sendChatMessage))(this, player, message);
		}
