...
namespace fdm
{
	...
	inline bool isModLoaded(const msvc_string& modId)
	{
		return reinterpret_cast<bool(__stdcall*)(const msvc_string&)>(GetProcAddress(GetModuleHandleA("4DModLoader-Core.dll"), "isModLoaded"))(modId);
	}
	inline bool isDLLLoaded(const msvc_string& dllFileName)
	{
		return reinterpret_cast<bool(__stdcall*)(const msvc_string&)>(GetProcAddress(GetModuleHandleA("4DModLoader-Core.dll"), "isDLLLoaded"))(dllFileName);
	}
	inline msvc_string getModDLL(const msvc_string& modId)
	{
		return reinterpret_cast<msvc_string(__stdcall*)(const msvc_string&)>(GetProcAddress(GetModuleHandleA("4DModLoader-Core.dll"), "getModDLL"))(modId);
	}
	inline msvc_string getModVersion(const msvc_string& modId)
	{
		return reinterpret_cast<msvc_string(__stdcall*)(const msvc_string&)>(GetProcAddress(GetModuleHandleA("4DModLoader-Core.dll"), "getModVersion"))(modId);
	}
	inline std::string getModName(const msvc_string& modId)
	{
		return reinterpret_cast<msvc_string(__stdcall*)(const msvc_string&)>(GetProcAddress(GetModuleHandleA("4DModLoader-Core.dll"), "getModName"))(modId);
	}
	inline msvc_string getModAuthor(const msvc_string& modId)
	{
		return reinterpret_cast<msvc_string(__stdcall*)(const msvc_string&)>(GetProcAddress(GetModuleHandleA("4DModLoader-Core.dll"), "getModAuthor"))(modId);
	}
	inline msvc_string getModDescription(const msvc_string& modId)
	{
		return reinterpret_cast<msvc_string(__stdcall*)(const msvc_string&)>(GetProcAddress(GetModuleHandleA("4DModLoader-Core.dll"), "getModDescription"))(modId);
	}
	inline HMODULE getModHandle(const msvc_string& modId)
	{
		return reinterpret_cast<HMODULE(__stdcall*)(const msvc_string&)>(GetProcAddress(GetModuleHandleA("4DModLoader-Core.dll"), "getModHandle"))(modId);
	}
	inline msvc_string getModloaderVersion()
	{
		return reinterpret_cast<msvc_string(__stdcall*)()>(GetProcAddress(GetModuleHandleA("4DModLoader-Core.dll"), "getModloaderVersion"))();
	}
	inline msvc_string getGameVersion()
	{
		return reinterpret_cast<msvc_string(__stdcall*)()>(GetProcAddress(GetModuleHandleA("4DModLoader-Core.dll"), "getGameVersion"))();
	}
	inline std::string getModPath(const msvc_string& modId)
	{
		return reinterpret_cast<msvc_string(__stdcall*)(const msvc_string&)>(GetProcAddress(GetModuleHandleA("4DModLoader-Core.dll"), "getModPath"))(modId);
	}
	// useful for creating library mod headers
	inline FARPROC getModFuncPointer(const msvc_string& modId, const msvc_string& funcName)
	{
	...
	*/
	inline bool versionCompare(const msvc_string& aVer, const msvc_string& op, const msvc_string& bVer)
	{
		return reinterpret_cast<bool(__stdcall*)(const msvc_string&, const msvc_string&, const msvc_string&)>(GetProcAddress(GetModuleHandleA("4DModLoader-Core.dll"), "versionCompare"))(aVer, op, bVer);
	}
	// splits string by a delimiter
	inline std::vector<msvc_string> splitStr(const msvc_string& str, char delim) {
		std::vector<msvc_string> tokens;
		size_t pos = 0;
		...
		while (pos < len)
		{
			size_t end = std::string(str).find_first_of(delim, pos);
			if (end == std::string::npos)
			{
				tokens.emplace_back(std::string(str).substr(pos));
				break;
			}
			tokens.emplace_back(std::string(str).substr(pos, end - pos));
			pos = end + 1;
		}
...
// used by modloader
extern "C" inline __declspec(dllexport) void setModID(const msvc_string& modID) { fdm::modID = modID; }
